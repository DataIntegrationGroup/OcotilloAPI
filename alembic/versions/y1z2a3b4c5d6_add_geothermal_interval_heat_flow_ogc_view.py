...
(NMW_GtHeatFlow), one feature per well with aggregate heat-flow / gradient /
conductivity / diffusivity stats. Distinct from ogc_geothermal_wells_heat_flow,
which is the summary (NMW_GtSumHeatFlow) layer.
