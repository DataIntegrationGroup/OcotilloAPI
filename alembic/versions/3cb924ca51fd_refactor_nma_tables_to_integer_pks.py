...
def upgrade() -> None:
    ...
    # ==========================================================================
    op.drop_constraint(
        op.f("NMA_MinorTraceChemistry_chemistry_sample_info_id_fkey"),
        "NMA_MinorTraceChemistry",
        type_="foreignkey",
    )
    op.drop_constraint(
        op.f("NMA_Radionuclides_SamplePtID_fkey"),
        "NMA_Radionuclides",
        type_="foreignkey",
    )
    op.drop_constraint(
        op.f("NMA_MajorChemistry_SamplePtID_fkey"),
        "NMA_MajorChemistry",
        type_="foreignkey",
    )
    op.drop_constraint(
        op.f("NMA_FieldParameters_SamplePtID_fkey"),
        "NMA_FieldParameters",
        type_="foreignkey",
    )
    ...
    op.add_column(
        "NMA_Chemistry_SampleInfo",
        sa.Column("nma_SamplePtID", sa.UUID(), nullable=True),
    )
    op.add_column(
        "NMA_Chemistry_SampleInfo",
        sa.Column("nma_WCLab_ID", sa.String(length=18), nullable=True),
    )
    op.add_column(
        "NMA_Chemistry_SampleInfo",
    ...
    op.add_column(
        "NMA_Chemistry_SampleInfo",
        sa.Column("nma_OBJECTID", sa.Integer(), nullable=True),
    )
    op.add_column(
        "NMA_Chemistry_SampleInfo",
        sa.Column("nma_LocationId", sa.UUID(), nullable=True),
    )

    # Drop old PK and create new PK on id
    op.drop_constraint(
        "NMA_Chemistry_SampleInfo_pkey", "NMA_Chemistry_SampleInfo", type_="primary"
    )
    op.create_primary_key(
        "NMA_Chemistry_SampleInfo_pkey", "NMA_Chemistry_SampleInfo", ["id"]
    )
    ...
    op.add_column(
        "NMA_FieldParameters", sa.Column("nma_GlobalID", sa.UUID(), nullable=True)
    )
    op.add_column(
        "NMA_FieldParameters",
    ...
    op.add_column(
        "NMA_FieldParameters", sa.Column("nma_SamplePtID", sa.UUID(), nullable=True)
    )
    op.add_column(
        "NMA_FieldParameters",
        sa.Column("nma_SamplePointID", sa.String(length=10), nullable=True),
    )
    op.add_column(
        "NMA_FieldParameters", sa.Column("nma_OBJECTID", sa.Integer(), nullable=True)
    )
    op.add_column(
        "NMA_FieldParameters",
    ...
    op.drop_index(
        op.f("FieldParameters$SamplePointID"), table_name="NMA_FieldParameters"
    )
    ...
    op.drop_index(
        op.f("FieldParameters$ChemistrySampleInfoFieldParameters"),
    ...
    op.create_index(
        "FieldParameters$nma_GlobalID",
        "NMA_FieldParameters",
        ["nma_GlobalID"],
        unique=True,
    )
    op.create_index(
        "FieldParameters$nma_OBJECTID",
        "NMA_FieldParameters",
        ["nma_OBJECTID"],
        unique=True,
    )
    op.create_index(
        "FieldParameters$nma_SamplePointID",
        "NMA_FieldParameters",
        ["nma_SamplePointID"],
        unique=False,
    )
    op.create_index(
        "FieldParameters$nma_WCLab_ID",
        "NMA_FieldParameters",
        ["nma_WCLab_ID"],
        unique=False,
    )
    ...
    op.add_column(
        "NMA_AssociatedData", sa.Column("nma_AssocID", sa.UUID(), nullable=True)
    )
    op.add_column(
        "NMA_AssociatedData", sa.Column("nma_LocationId", sa.UUID(), nullable=True)
    )
    op.add_column(
        "NMA_AssociatedData",
        sa.Column("nma_PointID", sa.String(length=10), nullable=True),
    )
    op.add_column(
        "NMA_AssociatedData", sa.Column("nma_OBJECTID", sa.Integer(), nullable=True)
    )
    op.drop_constraint(
        op.f("AssociatedData$LocationId"), "NMA_AssociatedData", type_="unique"
    )
    op.drop_index(op.f("AssociatedData$PointID"), table_name="NMA_AssociatedData")
    op.drop_constraint(
        op.f("NMA_AssociatedData_OBJECTID_key"), "NMA_AssociatedData", type_="unique"
    )
    ...
    op.add_column(
        "NMA_HydraulicsData", sa.Column("nma_GlobalID", sa.UUID(), nullable=True)
    )
    op.add_column(
        "NMA_HydraulicsData", sa.Column("nma_WellID", sa.UUID(), nullable=True)
    )
    op.add_column(
        "NMA_HydraulicsData",
        sa.Column("nma_PointID", sa.String(length=50), nullable=True),
    )
    op.add_column(
        "NMA_HydraulicsData", sa.Column("nma_OBJECTID", sa.Integer(), nullable=True)
    )
    op.drop_index(
        op.f("ix_nma_hydraulicsdata_objectid"), table_name="NMA_HydraulicsData"
    )
    op.drop_index(
        op.f("ix_nma_hydraulicsdata_pointid"), table_name="NMA_HydraulicsData"
    )
    ...
    op.add_column(
        "NMA_MajorChemistry", sa.Column("nma_GlobalID", sa.UUID(), nullable=True)
    )
    op.add_column(
        "NMA_MajorChemistry",
        sa.Column("chemistry_sample_info_id", sa.Integer(), nullable=False),
    ...
    op.add_column(
        "NMA_MajorChemistry", sa.Column("nma_SamplePtID", sa.UUID(), nullable=True)
    )
    op.add_column(
        "NMA_MajorChemistry",
        sa.Column("nma_SamplePointID", sa.String(length=10), nullable=True),
    ...
    op.add_column(
        "NMA_MajorChemistry", sa.Column("nma_OBJECTID", sa.Integer(), nullable=True)
    )
    op.add_column(
        "NMA_MajorChemistry",
        sa.Column("nma_WCLab_ID", sa.String(length=25), nullable=True),
    ...
    op.drop_index(
        op.f("MajorChemistry$AnalysesAgency"), table_name="NMA_MajorChemistry"
    )
    op.drop_index(op.f("MajorChemistry$Analyte"), table_name="NMA_MajorChemistry")
    op.drop_index(
        op.f("MajorChemistry$Chemistry SampleInfoMajorChemistry"),
        table_name="NMA_MajorChemistry",
    )
    op.drop_index(op.f("MajorChemistry$SamplePointID"), table_name="NMA_MajorChemistry")
    op.drop_index(
        op.f("MajorChemistry$SamplePointIDAnalyte"), table_name="NMA_MajorChemistry"
    )
    ...
    op.drop_constraint(
        op.f("NMA_MajorChemistry_OBJECTID_key"), "NMA_MajorChemistry", type_="unique"
    )
    ...
    op.add_column(
        "NMA_MinorTraceChemistry", sa.Column("nma_GlobalID", sa.UUID(), nullable=True)
    )
    op.add_column(
        "NMA_MinorTraceChemistry",
        sa.Column("nma_chemistry_sample_info_uuid", sa.UUID(), nullable=True),
    )
    op.alter_column(
        "NMA_MinorTraceChemistry",
        "chemistry_sample_info_id",
    ...
    op.add_column(
        "NMA_Radionuclides", sa.Column("nma_GlobalID", sa.UUID(), nullable=True)
    )
    op.add_column(
        "NMA_Radionuclides",
        sa.Column("chemistry_sample_info_id", sa.Integer(), nullable=False),
    ...
    op.add_column(
        "NMA_Radionuclides", sa.Column("nma_SamplePtID", sa.UUID(), nullable=True)
    )
    op.add_column(
        "NMA_Radionuclides",
        sa.Column("nma_SamplePointID", sa.String(length=10), nullable=True),
    ...
    op.add_column(
        "NMA_Radionuclides", sa.Column("nma_OBJECTID", sa.Integer(), nullable=True)
    )
    op.add_column(
        "NMA_Radionuclides",
        sa.Column("nma_WCLab_ID", sa.String(length=25), nullable=True),
    ...
    op.drop_constraint(
        op.f("NMA_Radionuclides_OBJECTID_key"), "NMA_Radionuclides", type_="unique"
    )
    ...
    op.drop_index(
        op.f("Radionuclides$Chemistry SampleInfoRadionuclides"),
        table_name="NMA_Radionuclides",
    )
    ...
    op.add_column(
        "NMA_Soil_Rock_Results",
        sa.Column("nma_Point_ID", sa.String(length=255), nullable=True),
    )
    op.drop_index(
        op.f("Soil_Rock_Results$Point_ID"), table_name="NMA_Soil_Rock_Results"
    )
    ...
    op.add_column(
        "NMA_Stratigraphy", sa.Column("nma_GlobalID", sa.UUID(), nullable=True)
    )
    op.add_column("NMA_Stratigraphy", sa.Column("nma_WellID", sa.UUID(), nullable=True))
    op.add_column(
        "NMA_Stratigraphy",
        sa.Column("nma_PointID", sa.String(length=10), nullable=False),
    )
    op.add_column(
        "NMA_Stratigraphy", sa.Column("nma_OBJECTID", sa.Integer(), nullable=True)
    )
    op.drop_constraint(
        op.f("NMA_Stratigraphy_OBJECTID_key"), "NMA_Stratigraphy", type_="unique"
    )
    ...
    op.drop_index(
        op.f("SurfaceWaterPhotos$PointID"), table_name="NMA_SurfaceWaterPhotos"
    )
    op.drop_index(
        op.f("SurfaceWaterPhotos$SurfaceID"), table_name="NMA_SurfaceWaterPhotos"
    )
    op.drop_constraint(
    ...
    op.drop_constraint(
        op.f("uq_nma_view_ngwmn_lithology_objectid"),
        "NMA_view_NGWMN_Lithology",
        type_="unique",
    )
    op.drop_constraint(
...
def downgrade() -> None:
    ...
    op.create_index(
        op.f("WeatherPhotos$WeatherID"),
        "NMA_WeatherPhotos",
        ["WeatherID"],
        unique=False,
    )
    op.create_index(
        op.f("WeatherPhotos$PointID"), "NMA_WeatherPhotos", ["PointID"], unique=False
    )
    op.create_unique_constraint(
        op.f("uq_nma_pressure_daily_globalid"),
        "NMA_WaterLevelsContinuous_Pressure_Daily",
    ...
    op.create_index(
        op.f("SurfaceWaterPhotos$SurfaceID"),
        "NMA_SurfaceWaterPhotos",
        ["SurfaceID"],
        unique=False,
    )
    op.create_index(
        op.f("SurfaceWaterPhotos$PointID"),
        "NMA_SurfaceWaterPhotos",
        ["PointID"],
        unique=False,
    )
    op.add_column(
        "NMA_Stratigraphy",
        sa.Column("GlobalID", sa.UUID(), autoincrement=False, nullable=False),
    )
    op.add_column(
        "NMA_Stratigraphy",
        sa.Column(
            "PointID", sa.VARCHAR(length=10), autoincrement=False, nullable=False
        ),
    )
    op.add_column(
        "NMA_Stratigraphy",
        sa.Column("WellID", sa.UUID(), autoincrement=False, nullable=True),
    )
    op.add_column(
        "NMA_Stratigraphy",
    ...
    op.drop_constraint(None, "NMA_Stratigraphy", type_="unique")
    op.create_index(
        op.f("ix_nma_stratigraphy_thing_id"),
        "NMA_Stratigraphy",
        ["thing_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_nma_stratigraphy_point_id"),
        "NMA_Stratigraphy",
        ["PointID"],
        unique=False,
    )
    op.create_unique_constraint(
        op.f("NMA_Stratigraphy_OBJECTID_key"),
        "NMA_Stratigraphy",
        ["OBJECTID"],
        postgresql_nulls_not_distinct=False,
    )
    ...
    op.add_column(
        "NMA_Soil_Rock_Results",
        sa.Column(
            "Point_ID", sa.VARCHAR(length=255), autoincrement=False, nullable=True
        ),
    )
    op.create_index(
        op.f("Soil_Rock_Results$Point_ID"),
        "NMA_Soil_Rock_Results",
        ["Point_ID"],
        unique=False,
    )
    ...
    op.add_column(
        "NMA_Radionuclides",
        sa.Column(
            "WCLab_ID", sa.VARCHAR(length=25), autoincrement=False, nullable=True
        ),
    )
    op.add_column(
        "NMA_Radionuclides",
        sa.Column("SamplePtID", sa.UUID(), autoincrement=False, nullable=False),
    )
    op.add_column(
        "NMA_Radionuclides",
        sa.Column(
            "SamplePointID", sa.VARCHAR(length=10), autoincrement=False, nullable=True
        ),
    )
    ...
    op.drop_constraint(None, "NMA_Radionuclides", type_="unique")
    op.create_index(
        op.f("Radionuclides$WCLab_ID"), "NMA_Radionuclides", ["WCLab_ID"], unique=False
    )
    op.create_index(
        op.f("Radionuclides$SamplePtID"),
        "NMA_Radionuclides",
        ["SamplePtID"],
        unique=False,
    )
    op.create_index(
        op.f("Radionuclides$SamplePointID"),
        "NMA_Radionuclides",
        ["SamplePointID"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("Radionuclides$Analyte"), "NMA_Radionuclides", ["Analyte"], unique=False
    )
    op.create_index(
        op.f("Radionuclides$AnalysesAgency"),
        "NMA_Radionuclides",
        ["AnalysesAgency"],
        unique=False,
    )
    ...
    op.drop_constraint(None, "NMA_MajorChemistry", type_="unique")
    op.create_unique_constraint(
        op.f("NMA_MajorChemistry_OBJECTID_key"),
        "NMA_MajorChemistry",
        ["OBJECTID"],
        postgresql_nulls_not_distinct=False,
    )
    op.create_index(
        op.f("MajorChemistry$WCLab_ID"),
        "NMA_MajorChemistry",
        ["WCLab_ID"],
        unique=False,
    )
    op.create_index(
        op.f("MajorChemistry$SamplePtID"),
        "NMA_MajorChemistry",
        ["SamplePtID"],
        unique=False,
    )
    op.create_index(
        op.f("MajorChemistry$SamplePointIDAnalyte"),
        "NMA_MajorChemistry",
        ["SamplePointID", "Analyte"],
        unique=False,
    )
    op.create_index(
        op.f("MajorChemistry$SamplePointID"),
        "NMA_MajorChemistry",
        ["SamplePointID"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("MajorChemistry$Analyte"), "NMA_MajorChemistry", ["Analyte"], unique=False
    )
    op.create_index(
        op.f("MajorChemistry$AnalysesAgency"),
        "NMA_MajorChemistry",
        ["AnalysesAgency"],
        unique=False,
    )
    ...
    op.add_column(
        "NMA_HydraulicsData",
        sa.Column("PointID", sa.VARCHAR(length=50), autoincrement=False, nullable=True),
    )
    op.add_column(
        "NMA_HydraulicsData",
        sa.Column("OBJECTID", sa.INTEGER(), autoincrement=False, nullable=True),
    ...
    op.drop_constraint(None, "NMA_HydraulicsData", type_="unique")
    op.create_index(
        op.f("ix_nma_hydraulicsdata_wellid"),
        "NMA_HydraulicsData",
        ["WellID"],
        unique=False,
    )
    op.create_index(
        op.f("ix_nma_hydraulicsdata_pointid"),
        "NMA_HydraulicsData",
        ["PointID"],
        unique=False,
    )
    op.create_index(
        op.f("ix_nma_hydraulicsdata_objectid"),
        "NMA_HydraulicsData",
        ["OBJECTID"],
        unique=True,
    )
    ...
    op.create_index(
        op.f("FieldParameters$WCLab_ID"),
        "NMA_FieldParameters",
        ["WCLab_ID"],
        unique=False,
    )
    op.create_index(
        op.f("FieldParameters$SamplePtID"),
        "NMA_FieldParameters",
        ["SamplePtID"],
        unique=False,
    )
    op.create_index(
        op.f("FieldParameters$SamplePointID"),
        "NMA_FieldParameters",
        ["SamplePointID"],
        unique=False,
    )
    op.create_index(
        op.f("FieldParameters$OBJECTID"),
        "NMA_FieldParameters",
        ["OBJECTID"],
        unique=True,
    )
    op.create_index(
        op.f("FieldParameters$GlobalID"),
        "NMA_FieldParameters",
        ["GlobalID"],
        unique=True,
    )
    ...
    op.add_column(
        "NMA_Chemistry_SampleInfo",
        sa.Column("LocationId", sa.UUID(), autoincrement=False, nullable=True),
    )
    op.add_column(
        "NMA_Chemistry_SampleInfo",
        sa.Column("OBJECTID", sa.INTEGER(), autoincrement=False, nullable=True),
    ...
    op.add_column(
        "NMA_Chemistry_SampleInfo",
        sa.Column(
            "WCLab_ID", sa.VARCHAR(length=18), autoincrement=False, nullable=True
        ),
    )
    op.add_column(
        "NMA_Chemistry_SampleInfo",
    ...
    op.add_column(
        "NMA_Chemistry_SampleInfo",
        sa.Column(
            "SamplePointID", sa.VARCHAR(length=10), autoincrement=False, nullable=False
        ),
    )
    ...
    op.add_column(
        "NMA_AssociatedData",
        sa.Column("PointID", sa.VARCHAR(length=10), autoincrement=False, nullable=True),
    )
    op.add_column(
        "NMA_AssociatedData",
        sa.Column("AssocID", sa.UUID(), autoincrement=False, nullable=False),
    )
    op.add_column(
        "NMA_AssociatedData",
        sa.Column("LocationId", sa.UUID(), autoincrement=False, nullable=True),
    ...
    op.drop_constraint(None, "NMA_AssociatedData", type_="unique")
    op.create_unique_constraint(
        op.f("NMA_AssociatedData_OBJECTID_key"),
        "NMA_AssociatedData",
        ["OBJECTID"],
        postgresql_nulls_not_distinct=False,
    )
    op.create_index(
        op.f("AssociatedData$PointID"), "NMA_AssociatedData", ["PointID"], unique=False
    )
    op.create_unique_constraint(
        op.f("AssociatedData$LocationId"),
        "NMA_AssociatedData",
        ["LocationId"],
        postgresql_nulls_not_distinct=False,
    )
