...
def upgrade() -> None:
    ...
    op.create_index('ix_owner_search_vector', 'owner', ['search_vector'], unique=False, postgresql_using='gin')
    ...
    op.create_table('owner_contact_association',
    ...
    op.create_table('sample_location',
    ...
    op.create_table('asset_location_association',
    sa.Column('asset_id', sa.Integer(), nullable=False),
    sa.Column('location_id', sa.Integer(), nullable=False),
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.ForeignKeyConstraint(['asset_id'], ['asset.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['location_id'], ['sample_location.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_table('group_location_association',
    ...
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.ForeignKeyConstraint(['formation_zone'], ['lexicon_term.term'], ),
    sa.ForeignKeyConstraint(['location_id'], ['sample_location.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['well_type'], ['lexicon_term.term'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index('ix_well_search_vector', 'well', ['search_vector'], unique=False, postgresql_using='gin')
    ...
    op.create_table('geothermal_sample_set',
    ...
    op.create_table('geothermal_temperature_profile',
    sa.Column('well_id', sa.Integer(), nullable=True),
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.ForeignKeyConstraint(['well_id'], ['well.id'], ondelete='CASCADE'),
    ...
    op.create_table('water_chemistry_analysis_set',
    sa.Column('well_id', sa.Integer(), nullable=True),
    ...
    sa.ForeignKeyConstraint(['sample_type'], ['lexicon_term.term'], ),
    sa.ForeignKeyConstraint(['well_id'], ['well.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_table('well_timeseries',
    sa.Column('well_id', sa.Integer(), nullable=False),
    ...
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('properties', sa.JSON(), nullable=True, comment='JSONB column for storing additional properties'),
    sa.ForeignKeyConstraint(['equipment_id'], ['equipment.id'], ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['well_id'], ['well.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('geothermal_bottom_hole_temperature_header',
    ...
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.ForeignKeyConstraint(['drill_fluid'], ['lexicon_term.term'], ),
    sa.ForeignKeyConstraint(['sample_set_id'], ['geothermal_sample_set.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('geothermal_temperature_profile_observation',
    ...
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.ForeignKeyConstraint(['depth_unit'], ['lexicon_term.term'], ),
    sa.ForeignKeyConstraint(['temperature_profile_id'], ['geothermal_temperature_profile.id'], ),
    sa.ForeignKeyConstraint(['temperature_unit'], ['lexicon_term.term'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('geothermal_well_interval',
    sa.Column('sample_set_id', sa.Integer(), nullable=True),
    ...
    op.create_table('groundwater_level_observation',
    ...
    sa.ForeignKeyConstraint(['data_quality'], ['lexicon_term.term'], ),
    sa.ForeignKeyConstraint(['level_status'], ['lexicon_term.term'], ),
    sa.ForeignKeyConstraint(['quality_control_status'], ['lexicon_term.term'], ),
    sa.ForeignKeyConstraint(['quality_control_user_id'], ['user.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['timeseries_id'], ['well_timeseries.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('water_chemistry_analysis',
    ...
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.ForeignKeyConstraint(['analysis_set_id'], ['water_chemistry_analysis_set.id'], ),
    sa.ForeignKeyConstraint(['analyte'], ['lexicon_term.term'], ),
    sa.ForeignKeyConstraint(['unit'], ['lexicon_term.term'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('geothermal_bottom_hole_temperature',
    ...
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.ForeignKeyConstraint(['depth_unit'], ['lexicon_term.term'], ),
    sa.ForeignKeyConstraint(['header_id'], ['geothermal_bottom_hole_temperature_header.id'], ),
    sa.ForeignKeyConstraint(['temperature_unit'], ['lexicon_term.term'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('geothermal_heat_flow',
    ...
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.ForeignKeyConstraint(['gradient_unit'], ['lexicon_term.term'], ),
    sa.ForeignKeyConstraint(['interval_id'], ['geothermal_well_interval.id'], ),
    sa.ForeignKeyConstraint(['ka_unit'], ['lexicon_term.term'], ),
    sa.ForeignKeyConstraint(['kpr_unit'], ['lexicon_term.term'], ),
    sa.ForeignKeyConstraint(['pm_unit'], ['lexicon_term.term'], ),
    sa.ForeignKeyConstraint(['q_unit'], ['lexicon_term.term'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('geothermal_thermal_conductivity',
    sa.Column('interval_id', sa.Integer(), nullable=True),
    sa.Column('conductivity', sa.Float(), nullable=True),
    sa.Column('conductivity_unit', sa.String(length=100), nullable=True),
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.ForeignKeyConstraint(['conductivity_unit'], ['lexicon_term.term'], ),
    sa.ForeignKeyConstraint(['interval_id'], ['geothermal_well_interval.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
...
def downgrade() -> None:
    ...
    op.drop_index('idx_sample_location_point', table_name='sample_location', postgresql_using='gist')
