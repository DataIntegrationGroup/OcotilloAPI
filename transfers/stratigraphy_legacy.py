...
class StratigraphyLegacyTransferer(Transferer):
    ...
    def _row_dict(self, row: pd.Series) -> Dict[str, Any] | None:
        ...
        nma_global_id = self._uuid_value(getattr(row, "GlobalID", None))
        ...
        return {
            ...
            "nma_WellID": self._uuid_value(getattr(row, "WellID", None)),
            "nma_PointID": point_id,
            "nma_OBJECTID": self._int_value(getattr(row, "OBJECTID", None)),
            # FK to Thing
            "thing_id": thing_id,
            # Data columns
